...
\end{tikzpicture}
\caption{Experimental design overview. Both branches receive the natural language description as input. 
The dashed arrow indicates the gold-standard Verus spec used solely for final evaluation.}
\label{fig:setup}
