...
We evaluate with two key questions to compare our results:
\begin{enumerate}
  \item How good is the model at producing code which satisfies the provided reward?
  \item How good is the model at producing correct code, 
  given that it satisfies the provided reward?
\end{enumerate}
