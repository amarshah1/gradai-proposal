...
\paragraph{Baseline Setup.} We fix Qwen3-Coder as the LLM generator, and use Qwen3-Coder as the LLM implementor.
...
model-generated Verus spec. Both branches were prompted with $5$
few-shot examples ($4$ correct implementations and $1$ reward hack,
