...
with unit tests as a popular metric for assessing correctness. 
...
\textbf{are formal specifications less susceptible to reward hacking compared to unit tests?}
We investigate this by applying the same pipeline to both unit tests and formal specs 
