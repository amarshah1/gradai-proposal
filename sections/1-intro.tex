...
% Additionally, the potential for reward hacking
% Add back in?
...
This is particularly inconvenient in the domain of self-play,
where reward-hackable metrics can lead to error propagation rather than true learning~\cite{lin2026learningsolveverifyselfplay}.
...
By doing so, we examine a key hypothesis in a recent self-play paper
which used formal specs rather than unit tests~\cite{PSV}, 
under the assumption that formal specs would act as more robust reward signals.
